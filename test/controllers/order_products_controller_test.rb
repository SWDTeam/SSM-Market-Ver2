...
class OrderProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_product" do
    assert_difference('OrderProduct.count') do
      post order_products_url, params: { order_product: { price: @order_product.price, quantity: @order_product.quantity, reason: @order_product.reason, status: @order_product.status } }
    end
  ...
  test "should update order_product" do
    patch order_product_url(@order_product), params: { order_product: { price: @order_product.price, quantity: @order_product.quantity, reason: @order_product.reason, status: @order_product.status } }
